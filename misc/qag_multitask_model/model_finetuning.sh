...
mlqg_answer () {
  ...
  do
    ...
    lmqg-eval-qag --use-auth-token -m "lmqg_output/${MODEL_NAME}-${LA}quad-multitask/best_model" -e "lmqg_output/${MODEL_NAME}-${LA}quad-multitask/best_model/eval" -d "lmqg/qg_${LA}quad" --language "${LA}"
...
lmqg-eval-qa -m "lmqg_output/t5-large-squad-answer-extraction/best_model" -e "lmqg_output/t5-large-squad-answer-extraction/best_model/eval" --language "en" -d "lmqg/qg_squad"
...
lmqg-eval-qa -m "lmqg_output/t5-base-squad-answer-extraction/best_model" -e "lmqg_output/t5-base-squad-answer-extraction/best_model/eval" --language "en" -d "lmqg/qg_squad"
...
lmqg-eval-qa -m "lmqg_output/t5-small-squad-answer-extraction/best_model" -e "lmqg_output/t5-small-squad-answer-extraction/best_model/eval" --language "en" -d "lmqg/qg_squad"
...
lmqg-eval-qa -m "lmqg_output/bart-large-squad-answer-extraction/best_model" -e "lmqg_output/bart-large-squad-answer-extraction/best_model/eval" --language "en" -d "lmqg/qg_squad"
...
lmqg-eval-qa -m "lmqg_output/bart-base-squad-answer-extraction/best_model" -e "lmqg_output/bart-base-squad-answer-extraction/best_model/eval" --language "en" -d "lmqg/qg_squad"
