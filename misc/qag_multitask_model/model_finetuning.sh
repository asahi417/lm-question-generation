...
lmqg-eval -m "lmqg_output/t5-base-squad-multitask/best_model" -e "lmqg_output/t5-base-squad-multitask/best_model/eval" --language "en" -d "lmqg/qg_squad" -i "paragraph_answer"
...
lmqg-eval -m "lmqg_output/t5-large-squad-multitask/best_model" -e "lmqg_output/t5-large-squad-multitask/best_model/eval" --language "en" -d "lmqg/qg_squad" -i "paragraph_answer"
