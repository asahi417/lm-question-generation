...
lmqg-push-to-hf -m "lmqg_output/t5_small_tweetqa/best_model" -a "t5-small-tweetqa-qag" -o "lmqg" -i "paragraph" -o 'questions_answers'
...
lmqg-push-to-hf -m "lmqg_output/t5_base_tweetqa/best_model" -a "t5-base-tweetqa-qag" -o "lmqg" -i "paragraph" -o 'questions_answers'
...
lmqg-push-to-hf -m "lmqg_output/t5_large_tweetqa/best_model" -a "t5-large-tweetqa-qag" -o "lmqg" -i "paragraph" -o 'questions_answers'
