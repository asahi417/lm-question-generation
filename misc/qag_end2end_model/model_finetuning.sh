...
lmqg-train-search -d lmqg/qag_tweetqa -m t5-large -b 16 -g 4 8 -c "lmqg_output/t5_large_tweetqa" -i 'paragraph' -o 'questions_answers' -p 'qag'
...
lmqg-train-search -d lmqg/qag_tweetqa -m t5-base  -b 32 -g 2 4 8 -c "lmqg_output/t5_base_tweetqa" -i 'paragraph' -o 'questions_answers' -p 'qag'
...
lmqg-train-search -d lmqg/qag_tweetqa -m t5-small -b 64 -g 1 2 4 -c "lmqg_output/t5_small_tweetqa" -i 'paragraph' -o 'questions_answers' -p 'qag'
