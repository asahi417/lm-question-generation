...
lmqg-eval-qa -m "lmqg_output/t5-small-tweetqa-question-answering/best_model" -e "lmqg_output/t5-small-tweetqa-question-answering/best_model/eval" -d "${DATA}" --language "${LA}" --batch-size 4
...
lmqg-eval-qa -m "lmqg_output/t5-base-tweetqa-question-answering/best_model" -e "lmqg_output/t5-base-tweetqa-question-answering/best_model/eval" -d "${DATA}" --language "${LA}" --batch-size 4
...
lmqg-eval-qa -m "lmqg_output/bart-base-tweetqa-question-answering/best_model" -e "lmqg_output/bart-base-tweetqa-question-answering/best_model/eval" -d "${DATA}" --language "${LA}" --batch-size 4
...
lmqg-eval-qa -m "lmqg_output/t5-large-tweetqa-question-answering/best_model" -e "lmqg_output/t5-large-tweetqa-question-answering/best_model/eval" -d "${DATA}" --language "${LA}" --batch-size 4
...
lmqg-eval-qa -m "lmqg_output/bart-large-tweetqa-question-answering/best_model" -e "lmqg_output/bart-large-tweetqa-question-answering/best_model/eval" -d "${DATA}" --language "${LA}" --batch-size 4
