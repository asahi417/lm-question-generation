...
WORD_INDEXER.addSentenceBatch(list(chain(*PAIRS)))
...
def train(input_tensor, target_tensor, encoder, decoder, encoder_optimizer, decoder_optimizer, criterion, teacher_forcing_ratio: float = 0.5):
...
encoder1 = EncoderRNN(WORD_INDEXER.n_words, hidden_size=256).to(DEVICE)
attn_decoder1 = AttnDecoderRNN(hidden_size=256, output_size=WORD_INDEXER.n_words, dropout_p=0.1, max_length=MAX_LENGTH).to(DEVICE)
