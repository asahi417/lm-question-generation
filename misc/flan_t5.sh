...
# QG
lmqg-train-search -m "google/flan-t5-large" -p qg -b 16 -g 4 8 16 32 -c "lmqg_output/flan-t5-large-squad"
...
lmqg-train-search -m google/flan-t5-small -p qg -b 32 -g 2 4 8 16 -c lmqg_output/flan_t5_small_squad
